...
import com.antaresnav.maps.AntaresMap.CancelableCallback;
import com.antaresnav.maps.AntaresMap.OnCameraIdleListener;
import com.antaresnav.maps.AntaresMap.OnCameraMoveCanceledListener;
import com.antaresnav.maps.AntaresMap.OnCameraMoveListener;
import com.antaresnav.maps.AntaresMap.OnCameraMoveStartedListener;
import com.antaresnav.maps.CameraUpdate;
...
import com.antaresnav.maps.model.CameraPosition;
 ...
 */
public class CameraAntaresActivity extends BaseExampleActivity implements
    ...
    public static final CameraPosition SYDNEY =
            new CameraPosition.Builder().target(new LatLng(-33.87365, 151.20689))
                    ...
                    .tilt(25)
                    .build();
    private static final String TAG = CameraAntaresActivity.class.getName();
    /**
    ...
    protected int getContentLayoutId() {
        return R.layout.content_camera_antares;
    }
