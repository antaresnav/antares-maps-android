...
import com.antaresnav.maps.demo.ui.OnAntaresMapAndViewReadyListener;
 ...
 */
public class MarkerAntaresActivity extends BaseExampleActivity implements
        OnMarkerClickListener,
        OnSeekBarChangeListener,
        OnMapReadyCallback,
        OnAntaresMapAndViewReadyListener.OnGlobalLayoutAndMapReadyListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new OnAntaresMapAndViewReadyListener(mapView, this);
    }

    @Override
    protected int getContentLayoutId() {
        return R.layout.content_marker_antares;
    }
